...
HD_PWD='C:/Users/18191/Desktop/Lab14/Lab14.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log colorDetect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source colorDetect.tcl
