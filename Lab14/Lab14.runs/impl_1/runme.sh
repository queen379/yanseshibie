...
HD_PWD='C:/Users/18191/Desktop/Lab14/Lab14.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log colorDetect.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source colorDetect.tcl -notrace
